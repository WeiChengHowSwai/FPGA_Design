...
HD_PWD='C:/Users/VLSILAB/Documents/GitHub/FPGA_Design/Lab03/Lab3-2/vivado_prj/vivado_prj.runs/led_ctrl_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log led_ctrl_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source led_ctrl_xbar_0.tcl
