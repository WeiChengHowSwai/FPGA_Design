...
HD_PWD='C:/Users/VLSILAB/Documents/GitHub/FPGA_Design/Lab03/Lab3-1/vivado_prj/vivado_prj.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log processor_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source processor_wrapper.tcl -notrace
