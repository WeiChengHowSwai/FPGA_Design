...
HD_PWD='C:/Users/VLSILAB/Documents/GitHub/FPGA_Design/Lab03/Lab3-2/vivado_prj/vivado_prj.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log led_ctrl_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source led_ctrl_wrapper.tcl
