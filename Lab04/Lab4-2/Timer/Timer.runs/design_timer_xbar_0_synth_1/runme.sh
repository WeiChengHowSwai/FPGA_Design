...
HD_PWD='/home/ldap-users/shiyong/Downloads/FPGA/Timer/Timer.runs/design_timer_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_timer_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_timer_xbar_0.tcl
