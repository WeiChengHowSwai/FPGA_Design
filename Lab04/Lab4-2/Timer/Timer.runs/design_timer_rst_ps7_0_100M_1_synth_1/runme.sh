...
HD_PWD='/home/ldap-users/shiyong/Downloads/FPGA/Timer/Timer.runs/design_timer_rst_ps7_0_100M_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_timer_rst_ps7_0_100M_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_timer_rst_ps7_0_100M_1.tcl
