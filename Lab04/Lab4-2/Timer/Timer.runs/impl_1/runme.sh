...
HD_PWD='/home/ldap-users/shiyong/Downloads/FPGA/Timer/Timer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_timer_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_timer_wrapper.tcl -notrace
