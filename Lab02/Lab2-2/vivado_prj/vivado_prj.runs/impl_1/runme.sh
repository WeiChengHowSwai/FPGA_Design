...
HD_PWD='C:/Users/VLSILAB/Documents/GitHub/FPGA_Design/Lab02/Lab2-2/vivado_prj/vivado_prj.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log blinky_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source blinky_bd_wrapper.tcl -notrace
