...
HD_PWD='C:/Users/VLSILAB/Documents/GitHub/FPGA_Design/Lab02/Lab2-2/vivado_prj/vivado_prj.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blinky_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blinky_bd_wrapper.tcl
