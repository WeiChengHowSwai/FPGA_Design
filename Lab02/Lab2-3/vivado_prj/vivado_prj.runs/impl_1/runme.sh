...
HD_PWD='C:/Users/VLSILAB/Documents/FPGA_Design/Lab02/Lab2-3/vivado_prj/vivado_prj.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RGB_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RGB_top.tcl -notrace
