...
HD_PWD='C:/Users/VLSILAB/Documents/FPGA_Design/Lab02/Lab2-3/vivado_prj/vivado_prj.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RGB_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RGB_top.tcl
