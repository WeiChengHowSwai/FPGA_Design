...
HD_PWD='c:/users/vlsilab/documents/github/fpga_design/lab05/ip_repo/edit_adder_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adder_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adder_v1_0.tcl
