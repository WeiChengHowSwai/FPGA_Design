...
HD_PWD='c:/users/user/desktop/fpga_design/lab05/ip_repo/edit_adder_v1_0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log adder_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source adder_v1_0.tcl -notrace
