...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Decoder is
  ...
  signal \G_time__0\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal G_time_n_0 : STD_LOGIC;
  ...
  signal \R_time_inferred__0/i__n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \B_time[0]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \B_time[2]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \B_time[3]_i_2\ : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of \G_time[2]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \G_time[3]_i_1\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \R_time[0]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \R_time[1]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \R_time[2]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \R_time[3]_i_1\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of \R_time_out_reg[3]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of led4_g_INST_0 : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of led4_r_INST_0 : label is "soft_lutpair6";
  attribute XILINX_LEGACY_PRIM of \led_reg[0]\ : label is "LD";
  attribute SOFT_HLUTNM of \led_reg[0]_i_1\ : label is "soft_lutpair5";
  attribute XILINX_LEGACY_PRIM of \led_reg[1]\ : label is "LD";
  attribute XILINX_LEGACY_PRIM of \led_reg[2]\ : label is "LD";
  attribute SOFT_HLUTNM of \led_reg[2]_i_1\ : label is "soft_lutpair2";
  attribute XILINX_LEGACY_PRIM of \led_reg[3]\ : label is "LD";
  attribute SOFT_HLUTNM of \led_reg[3]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \led_reg[3]_i_2\ : label is "soft_lutpair1";
begin
...
G_time: unisim.vcomponents.LUT4
    generic map(
      INIT => X"5400"
    )
        port map (
...
\G_time[3]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"BF40FD02"
    )
        port map (
...
\R_time[3]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"BF40FD02"
    )
        port map (
...
\R_time_inferred__0/i_\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"4440"
    )
        port map (
...
\led_reg[3]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PWM_ctrl_v1_0_S00_AXI is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \axi_araddr[2]_i_1\ : label is "soft_lutpair11";
...
top_i: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_top
     port map (
      Q(4 downto 3) => slv_reg0(5 downto 4),
      Q(2) => rst,
      Q(1 downto 0) => slv_reg0(1 downto 0),
      \axi_rdata_reg[3]\(3 downto 0) => led_data(3 downto 0),
      led4_b => led4_b,
      led4_g => led4_g,
      led4_r => led4_r,
      s00_axi_aclk => s00_axi_aclk
