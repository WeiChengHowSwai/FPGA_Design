...
HD_PWD='D:/123NCKU/FPGA/Lab5_HW_v2/Lab5_HW_v2.runs/design_1_ParityGenerator_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_ParityGenerator_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_ParityGenerator_0_0.tcl
