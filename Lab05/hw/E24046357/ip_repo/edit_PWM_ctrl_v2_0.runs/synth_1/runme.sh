...
HD_PWD='d:/123ncku/fpga/ip_repo/edit_PWM_ctrl_v2_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PWM_ctrl_v2_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PWM_ctrl_v2_0.tcl
