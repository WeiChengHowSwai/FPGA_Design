...
HD_PWD='C:/Users/Leo/Desktop/FPGA/hw5/hw5.runs/hw5_parity_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hw5_parity_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hw5_parity_0_1.tcl
