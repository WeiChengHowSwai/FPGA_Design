...
#
# Generated by export_simulation on Sun Dec 02 20:41:19 +0800 2018
#
################################################################################
...
'-reset_run' switch to the './hw5.sh' script.
...
./hw5.sh -noclean_files

For more information on the script, please type './hw5.sh -help'.
