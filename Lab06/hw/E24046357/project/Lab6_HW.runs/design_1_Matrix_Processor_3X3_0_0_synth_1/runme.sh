...
HD_PWD='D:/123NCKU/FPGA/Lab6_HW/Lab6_HW.runs/design_1_Matrix_Processor_3X3_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_Matrix_Processor_3X3_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_Matrix_Processor_3X3_0_0.tcl
