...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_memory_ctrl is
  ...
  signal nolabel_line30_i_1_n_0 : STD_LOGIC;
...
nolabel_line30: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_mem256X8
     port map (
      address(7 downto 0) => address(7 downto 0),
      clk => clk,
      data_in(7 downto 0) => data_in_to_mem(7 downto 0),
      data_out(7 downto 0) => data_out(7 downto 0),
      write_enable => nolabel_line30_i_1_n_0
    );
nolabel_line30_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
      I0 => state(1),
      I1 => state(0),
      O => nolabel_line30_i_1_n_0
    );
nolabel_line30_i_2: unisim.vcomponents.LUT3
    generic map(
      INIT => X"08"
    )
        port map (
...
nolabel_line30_i_3: unisim.vcomponents.LUT3
    generic map(
      INIT => X"08"
    )
        port map (
...
nolabel_line30_i_4: unisim.vcomponents.LUT3
    generic map(
      INIT => X"08"
    )
        port map (
...
nolabel_line30_i_5: unisim.vcomponents.LUT3
    generic map(
      INIT => X"08"
    )
        port map (
...
nolabel_line30_i_6: unisim.vcomponents.LUT3
    generic map(
      INIT => X"08"
    )
        port map (
...
nolabel_line30_i_7: unisim.vcomponents.LUT3
    generic map(
      INIT => X"08"
    )
        port map (
...
nolabel_line30_i_8: unisim.vcomponents.LUT3
    generic map(
      INIT => X"08"
    )
        port map (
...
nolabel_line30_i_9: unisim.vcomponents.LUT3
    generic map(
      INIT => X"08"
    )
        port map (
